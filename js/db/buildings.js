...
(function (X) {
  const D = [
    ...
    { id: 'plot',  name: '灵田', cat: '生产', w: 2, h: 2, cost: { wood: 2 }, work: 40, passable: true, kind: 'plot', glyph: '田', el: 4, tags: { farm: 1 } },
    ...
    { id: 'alchemy', name: '丹房', cat: '后期', w: 3, h: 3, cost: { stone: 16, wood: 12 }, work: 400, passable: false, kind: 'lock', glyph: '丹', el: 3, tags: { lock: 'P3' } },
    { id: 'talisman', name: '符案', cat: '后期', w: 2, h: 2, cost: { wood: 10 }, work: 300, passable: true, kind: 'lock', glyph: '符', el: 1, tags: { lock: 'P3' } },
  ];
  X.Buildings = {
    list: D,
    byId: {},
    cats: ['结构', '起居', '道场', '生产', '仓储', '装饰', '卫生', '后期'],
  };
